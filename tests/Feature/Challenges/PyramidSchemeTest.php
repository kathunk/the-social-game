...
function joinDuringPyramidScheme($player, $team_id): LivewireTest
{
...
it('runs the Pyramid Scheme challenge', function () {
    ...
    joinDuringPyramidScheme($player_1, $team->id);
    joinDuringPyramidScheme($player_2, $team_2->id);
    joinDuringPyramidScheme($player_3, $team_2->id);
...
describe('validate swapTeam', function () {
    it('team_id is required', function () {
        ...
        joinDuringPyramidScheme($player->fresh(), $this->game->teams->first()->id);
...
describe('validate joinTeam', function () {
    it('team_id is required', function () {
        ...
        joinDuringPyramidScheme($player->fresh(), '', PyramidScheme::key())
    ...
    it('team_id must be a valid team', function () {
        ...
        joinDuringPyramidScheme($player->fresh(), 999, PyramidScheme::key())
