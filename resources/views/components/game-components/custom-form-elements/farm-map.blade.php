...
<div>
    <div style="display: grid; grid-template-columns: 30px repeat({{ $maxX + 1 }}, 1fr); gap: 4px;">
        ...
        <div style="border: 1px solid #ccc; padding: 8px; min-height: 40px; display: flex; align-items: center; justify-content: center; background-color: #f5f5f5; font-weight: bold;">
        </div>
        ...
        @for($y = 0; $y <= $maxY; $y++)
            ...
            @for($x = 0; $x <= $maxX; $x++)
                <div style="border: 1px solid #ccc; padding: 8px; min-height: 40px; display: flex; align-items: center; justify-content: center;">
                    @if(isset($grid[$y][$x]))
