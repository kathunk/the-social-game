...
use App\Events\PeckingOrder\PlayerBecameInvisible;
...
class IndividualFewestHiddenPointQuiz extends BaseChallengeClass implements SupportsPeckingOrderBallots
{
    ...
    const NAME = 'Nothing to hide';

    const DESCRIPTION = 'You may choose to go invisible: all votes you receive this round will count as hidden points. Guess which player will have the fewest hidden points at the end of the challenge. If you are correct, you will gain one hidden point.';
    ...
    public function frontendComponent(Player $player): array
    {
        ...
        $quiz_description = $has_guessed
            ? '🤔 Guessed that '.Player::find($this->challenge->challenge_data['quiz_submissions'][$player->id]['guess_player_id'])->name.
                ' will have the fewest hidden points at the end of this round.'
            : null;
