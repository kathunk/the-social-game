...
class IndividualFewestHiddenPointQuiz extends BaseChallengeClass implements SupportsPeckingOrderBallots
{
    ...
    const DESCRIPTION = 'All votes from this challenge will count toward hidden points. Guess which player had the fewest hidden points at the beginning of this challenge. If you are correct, you will gain one hidden point, that will not be revealed to your opponents until the end of the game.';
